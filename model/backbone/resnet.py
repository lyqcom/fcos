...
#         if if_include_top:
#             self.fc = nn.Dense(in_channels=512 * block.expansion, out_channels=num_classes, weight_init='normal',
...
#                 print("...")
#                 m.gamma.set_data(Tensor(np.ones(m.gamma.shape),dtype=mindspore.float32))
#                 m.beta.set_data(Tensor(np.zeros(m.beta.shape),dtype=mindspore.float32))
#
...
#     if pretrained:
#         print("pretrained")
#         param_dict = load_checkpoint(r'E:\PythonProject\r1fcos\test\ms_resnet_5.ckpt')
...
def resnet50(pretrained=True,class_num=1001):
        ...
        if pretrained:
            ...
            # param_dict = load_checkpoint(r'E:\PythonProject\r1fcos\test\model\backbone\resnet50_ascend_v130_imagenet2012_official_cv_bs256_top1acc76.97__top5acc_93.44.ckpt')
            param_dict = load_checkpoint(r'/home/zsl_2/model/backbone/resnet50_ascend_v130_imagenet2012_official_cv_bs32_acc77.06.ckpt')
            load_param_into_net(model,param_dict)
...
def resnet152(pretrained=True,class_num=1001):
    """
    ...
    if pretrained:
        ...
        param_dict = load_checkpoint(
            r'resnet152_ascend_v130_imagenet2012_official_cv_bs32_top1acc78.72__top5acc94.32.ckpt')
        print(param_dict)
        load_param_into_net(model, param_dict)
